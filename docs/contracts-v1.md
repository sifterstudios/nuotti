...
## Problem details (NuottiProblem)

For consistent error payloads across services, use the shared NuottiProblem record under `Nuotti.Contracts.V1.Model`.
...
// record NuottiProblem(string Title, int Status, string Detail, ReasonCode Reason, string? Field = null, Guid? CorrelationId = null)

var correlationId = Guid.NewGuid();

// 400 Bad Request
var p400 = NuottiProblem.BadRequest(
    title: "Invalid input",
    detail: "songIndex must be >= 0",
    reason: ReasonCode.InvalidStateTransition,
    field: "songIndex",
    correlationId: correlationId);

// 409 Conflict
var p409 = NuottiProblem.Conflict(
    title: "Duplicate command",
    detail: "This command was already processed",
    reason: ReasonCode.DuplicateCommand,
    correlationId: correlationId);

// 422 Unprocessable Entity
var p422 = NuottiProblem.UnprocessableEntity(
